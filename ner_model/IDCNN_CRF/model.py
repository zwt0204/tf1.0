...
"""
@File    : model.py
@Time    : 2019/11/28 17:26
@Author  : zwt
@git   : https://github.com/crownpku/Information-Extraction-Chinese/tree/master/NER_IDCNN_CRF
@Software: PyCharm
"""
import numpy as np
...
from ner_model.IDCNN_CRF.data_utils import iobes_iob


class IDCNN_Model(object):
    def __init__(self, lr, char_dim, seg_dim, num_tags, num_chars, is_train=True):
    ...
    def embedding_layer(self, char_inputs, seg_inputs, name=None):
        embedding = []
